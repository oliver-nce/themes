...
export const TOKEN_FIELDS: readonly string[] = ["primary_color", "secondary_color", "accent_color", "success_color", "info_color", "warning_color", "danger_color", "neutral_color", "text_color", "heading_color", "muted_color", "link_color", "focus_color", "background_color", "surface_color", "border_color", "row_alt_color", "font_family", "heading_font_family", "font_size", "line_height", "font_weight_body", "border_radius", "border_width_thin", "border_width", "border_width_strong", "spacing_scale", "shadow", "shadow_color", "shadow_opacity", "shadow_direction", "transition_speed", "sidebar_width", "container_max_width", "tailwind_overrides", "custom_css", "dark_mode", "primary_color_gamma", "primary_color_saturation", "secondary_color_gamma", "secondary_color_saturation", "neutral_color_warmth", "neutral_color_shades", "brand_palette_mode", "primary_color_fg_flip_mono_1", "primary_color_fg_flip_mono_2", "primary_color_fg_flip_tonal_1", "primary_color_fg_flip_tonal_2", "secondary_color_fg_flip_mono_1", "secondary_color_fg_flip_mono_2", "secondary_color_fg_flip_tonal_1", "secondary_color_fg_flip_tonal_2"] as const
